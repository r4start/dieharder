...
GSL_VAR const gsl_rng_type *gsl_rng_cpp_mt19937;     /* r4start Jan 2017 */
GSL_VAR const gsl_rng_type *gsl_rng_cpp_bad_mt19937; /* r4start Jan 2017 */
...
extern unsigned int
    dh_num_dieharder_rngs; /* dh rngs available in libdieharder */
extern unsigned int
    dh_num_R_rngs; /* R-derived rngs available in libdieharder */
extern unsigned int
    dh_num_hardware_rngs; /* hardware rngs supported in libdieharder */
extern unsigned int dh_num_user_rngs; /* user-added rngs */
extern unsigned int
    dh_num_reserved_rngs; /* ngs added in reserved space by new UI */
